 ...
 */
var bn = require('/Users/peter087744982/node_modules/jsbn');
//var bn = require('jsbn');
...
var PublicKey = (function () {
    ...
    PublicKey.prototype.createBNOp = function (c1,c2 ) {
       var paillier_cipher1 = convertToBN(c1);
       var paillier_cipher2 = convertToBN(c2);
       return paillier_cipher1.multiply(paillier_cipher2).mod(this.nsquare);
    };
    ;
    /**
 ...
 */
function generate_paillier_keypair(n_length,n1,lam,mu) {
    var keysize;
    ...
    else if(typeof n_length == "number" && typeof n1 =="string" && typeof lam=="string" ){
      console.log('Victory');
      keysize = n_length;
      console.log("Generating new keypair with " + keysize + " bit length key");
      var p, q, n, g, phi_n, mu;

      n = new bn(n1.toString(),10);
      //console.log("n1 : "+n);
      //console.log("type of : "+typeof(n));
      g = n.add(bn.ONE);
      //console.log("g1 : "+g);
      mu = new bn(mu.toString(),10);
      //console.log("mu1 : "+mu);
      phi_n = new bn(lam.toString(),10);
      //console.log("lamda1 : "+phi_n);
    }
    else {
        keysize = n_length;
        console.log("Generating new keypair with " + keysize + " bit length key");
        ...
        //mu = new bn(mu.toString(),10);
        //console.log("mu1 : "+mu);
        //phi_n = new bn(lamda.toString(),10);
        //console.log("lamda1 : "+phi_n);
        var pubKey = new PublicKey(g, n);
        return {
            public_key: pubKey,
